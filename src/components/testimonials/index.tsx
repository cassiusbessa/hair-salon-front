...
const items = [
	{content: 'Some testimonial to give an example 1', alt: ''},
	{content: 'Some testimonial to give an example 2', alt: ''},
	{content: 'Some testimonial to give an example 3', alt: ''},
	{content: 'Some testimonial to give an example 4', alt: ''},
	{content: 'Some testimonial to give an example 5', alt: ''},
];
